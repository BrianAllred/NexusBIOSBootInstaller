...
#include "7za.h"
#include "7za_log.h"
#include "com_frozeninferno_nexusbios_Andro7za.h"
...
*/
static const char *test_args [TEST_ARGC+1] = {
    "7za",
//    "x",
//    "-y",
//    "-piBlm8NTigvru0Jr0",
...
{
    const char *outputPathString = env->GetStringUTFChars(outputPath, 0);
    const char *inputFileString = env->GetStringUTFChars(inputFile, 0);

    static const char *unpackArgs [ARGC+1] = {
        "7za",
        "x",
        "-y",
        "-piBlm8NTigvru0Jr0",
    ...
    LOG_D("call Java_com_frozeninferno_nexusbios_Andro7za_a7za_1unpack.\n");
    jint ret = andro7za_main(ARGC, unpackArgs);

    env->ReleaseStringUTFChars(outputPath, outputPathString);
    env->ReleaseStringUTFChars(inputFile, inputFileString);
...
JNIEXPORT jint JNICALL Java_com_frozeninferno_nexusbios_Andro7za_a7za_1print_1usage
  (JNIEnv *, jobject)
{
    LOG_D("call Java_com_frozeninferno_nexusbios_Andro7za_a7za_1print_1usage.\n");
    jint ret = run_7za(TEST_ARGC, test_args);
    return ret;
}
